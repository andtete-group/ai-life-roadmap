...
export function accountEmail(username, admin=false){ const v=username.trim().toUpperCase(); if(admin)return "admin@ai-life.local";if(v==="AILIFE")return "member@ai-life.local";return `${v.toLowerCase().replace(/[^a-z0-9]/g,"")}@ai-life.local`; }
