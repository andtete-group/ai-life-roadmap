...
export function accountEmail(username, admin=false){ const v=username.trim().toLowerCase(); if(admin && v==="admin") return "admin@ai-life.local"; if(!admin && v==="member") return "member@ai-life.local"; return v.includes("@")?v:`${v}@ai-life.local`; }
