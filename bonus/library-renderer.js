...
if(grid){
  ...
  const posts=[
    ...
    ...Object.entries(window.AILifeBonusArticles).map(([no,a])=>({no:Number(no),...a,published:no==="23"?"2026-08-22":"2026-08-18",updated:no==="23"?"2026-08-22":"2026-08-18",href:`./article.html?no=${no}`}))
  ...
  const updates=[
    ["2026-08-22","Cloudflare初心者実践講座を追加","NEW"],
